		...
		<div class="col-lg-6">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h5><i class="fa fa-pencil"></i> Edit Data Gejala</h5>
                </div>
                <div class="panel-body">
        	        ...
        	        <form class="form-horizontal" action="<?php echo base_url().'gejala/save';?>" method="post">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="id_gejala" name="id_gejala" placeholder="* ID Gejala" required="on" value="<?php echo $record[0]->id_gejala;?>" readonly="on" maxlength="5">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="gejala" name="gejala" placeholder="* Isi Gejala" required="on" autofocus="on" value="<?php echo $record[0]->gejala;?>" maxlength="100">
                        </div>
                      </div>
                      <div class="form-group">
                        <label for="bobot" class="col-sm-2 control-label">Bobot<strong style="color: red;">*</strong></label>
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="bobot" name="bobot" placeholder="* Isi bobot gejala" required="on" autofocus="on" value="<?php echo $record[0]->bobot;?>" maxlength="3">
