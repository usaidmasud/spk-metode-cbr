                ...
                <div class="panel-body">
        	        ...
        	        <form class="form-horizontal" action="<?php echo base_url().'kasus/save';?>" method="post">
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <input type="text" class="form-control" id="id_kasus" name="id_kasus" placeholder="* Isi Nama Pasien" required="on" readonly="on" value="<?php echo $record[0]->id_kasus;?>" maxlength="5">
                        </div>
                      </div>
